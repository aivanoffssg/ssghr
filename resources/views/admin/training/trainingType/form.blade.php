									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('training_type_name',Input::old('training_type_name'), $attributes = array('class'=>'form-control required training_type_name','id'=>'training_type_name','placeholder'=>__('training.training_type_name'))) !!}
												</div>
											</div>
										</div>
									</div>
