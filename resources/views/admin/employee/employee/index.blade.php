						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select name="department_id" class="form-control department_id  select2" onchange="getData(1)">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select name="designation_id" class="form-control designation_id select2" onchange="getData(1)">
