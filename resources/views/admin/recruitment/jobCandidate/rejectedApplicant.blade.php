				...
				@foreach($results as $value)
					<div class="col-md-offset-2 col-md-7 ">
						<div class="panel panel-default">
							<div class="panel-heading">{{$value->applicant_name}} <span class="applicationDate">&nbsp; Applicant Rejected for </span>{{$job->post}} <span class="applicationDate">&nbsp;Position </span></div>
