...
@section('content')
@section('title','Apply Candidate List')
<style>
	.downloadResume{
		font-size: 15px;
		color: #777;
				...
				@foreach($results as $value)
					<div class="col-md-offset-2 col-md-7 ">
						<div class="panel panel-default">
							<div class="panel-heading">{{$value->applicant_name}} <span class="applicationDate">&nbsp;Applied for </span>{{$job->post}} <span class="applicationDate">&nbsp;Position </span></div>
							<div class="panel-wrapper collapse in">
								...
								<div class="panel-footer">
									...
									@elseif($value->status == 0)
										<a href="{{route('applicant.shortlist',$value->job_applicant_id)}}" onclick="return confirm('you are want to shortlist this applicant.are you sure?')"> <button type="submit" class="btn btn-info"><i class="fa fa-check"></i> Short Listed</button></a>
